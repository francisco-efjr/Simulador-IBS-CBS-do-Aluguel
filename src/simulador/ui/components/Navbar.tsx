          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-positive-text bg-positive-bg border border-positive-border px-2 py-0.5 rounded-full font-sim-mono">
                  LC 214/2025
                </span>
              ...
              <h1 className="text-sm sm:text-base md:text-lg font-bold text-text-primary tracking-tight leading-tight mt-0.5">
