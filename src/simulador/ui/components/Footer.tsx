      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-8 border-b border-sim-border">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm font-medium text-text-secondary">
            <a href="#simulador" onClick={(e) => handleTabClick('single', e)} className="hover:text-text-primary transition-colors">
              Individual
            </a>
            <span className="text-text-muted ">&bull;</span>
            <a href="#simulador" onClick={(e) => handleTabClick('portfolio', e)} className="hover:text-text-primary transition-colors">
              Portfólio
            </a>
            <span className="text-text-muted ">&bull;</span>
            <a href="#simulador" onClick={(e) => handleTabClick('comparative', e)} className="hover:text-text-primary transition-colors">
              Comparativo
            </a>
            {isProfessional && (
              <>
                <span className="text-text-muted ">&bull;</span>
                <a href="#simulador" onClick={(e) => handleTabClick('legal', e)} className="hover:text-text-primary transition-colors">
                  Fundamentação Jurídica
                </a>
                <span className="text-text-muted ">&bull;</span>
                <a href="#simulador" onClick={(e) => handleTabClick('api', e)} className="hover:text-text-primary transition-colors">
                  API
                </a>
              </>
            )}
