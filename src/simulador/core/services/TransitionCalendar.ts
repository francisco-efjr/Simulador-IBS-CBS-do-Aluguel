...
export class TransitionCalendar {
  ...
  public static getFullSchedule(
    ...
    return {
      metadata: {
        legalBasis: 'Emenda Constitucional nº 132/2023 e Lei Complementar nº 214/2025 (Arts. 255 a 265)',
        source: 'Diário Oficial da União / Senado Federal / Receita Federal do Brasil',
        lastVerifiedAt: new Date().toISOString(),
        status: 'VIGENTE_E_VALIDADO',
        reductionRule: 'Redução de 70% na alíquota padrão para locação e cessão onerosa de bens imóveis (Art. 260)',
        cibObligation: 'Obrigatoriedade de inscrição no Cadastro Imobiliário Brasileiro - CIB para emissão de NFS-e (Art. 265)',
      },
  ...
  public static getRatesForYear(
    ...
    switch (year) {
      case 2026:
        ...
        description = 'Alíquota de teste de 1,0% (0,9% CBS + 0,1% IBS), compensável com tributos federais.';
        isTestPhase = true;
        break;
      ...
      case 2029:
        ...
        nominalCbs = fullCbsRef;
        nominalIbs = FinancialMath.round(fullIbsRef * 0.10);
      ...
      case 2030:
        nominalCbs = fullCbsRef;
        nominalIbs = FinancialMath.round(fullIbsRef * 0.20);
      ...
      case 2031:
        nominalCbs = fullCbsRef;
        nominalIbs = FinancialMath.round(fullIbsRef * 0.30);
      ...
      case 2032:
        nominalCbs = fullCbsRef;
        nominalIbs = FinancialMath.round(fullIbsRef * 0.40);
