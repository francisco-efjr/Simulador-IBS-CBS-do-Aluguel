...
export const LEGAL_REFERENCES = {
  ...
  REAL_ESTATE_REGIME: {
    ...
    socialDeductionArticle:
      'Art. 260 da LC 214/2025 (Redutor Social de R$ 600,00/mês para imóveis residenciais)',
    exclusionsArticle:
      'Arts. 255 e 260 da LC 214/2025 (Exclusão de IPTU e taxas condominiais da base)',
    cibArticle: 'Art. 265 da LC 214/2025 (Cadastro de Identificação de Bens Imóveis - CIB)',
  },
  ENQUADRAMENTO_PF: {
    description:
      'A PF só se torna contribuinte se possuir mais de 3 imóveis alugados E receita anual com locações superior a R$ 240 mil.',
    rule: 'Cumulativo: (Imóveis > 3) E (Receita Anual > R$ 240.000)',
    legalArticle: 'Art. 249 e seguintes da LC 214/2025',
  },
  NON_CUMULATIVITY: {
    description:
      'Não-cumulatividade plena: Débito da locação deduzido dos créditos sobre insumos (imobiliária, manutenção) e aproveitamento de 100% pelo locatário PJ no regime regular.',
